...
import com.ibm.ssi.integration.hotel.security.AuthFilter;
import com.ibm.ssi.integration.hotel.security.AuthManager;
...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    @Value("${ssibk.hotel.integrationservice.apikey}")
