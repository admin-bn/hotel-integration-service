...
package com.ibm.ssi.integration.hotel.service;
...
public interface BackendService {
    ...
    List<BookingDataDTO> lookup(String bookingNumber, CheckInCredentialDTO check);

	PMSDataDTO pmsData(PMSDataDTO pmsDataDTO);
}
